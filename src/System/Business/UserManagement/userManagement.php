...
function elm_UserMgmt_isUsernameUnique($username, $id=null){
...
function elm_Page_UserManagementFunctionality(){
    ...
    if (isset($_POST['elm_NewUser_Execute_admin'])) {
        if (isset($_POST['elm_AddUser_Username']) && isset($_POST['elm_AddUser_Email']) && isset($_POST['elm_AddUser_Password']) && isset($_POST['elm_AddUser_Roll'])) {
            header("Location: index.php?isUnique".(elm_UserMgmt_isUsernameUnique($_POST['elm_AddUser_Username']) === true ? "true" : "false"));
            if (elm_UserMgmt_isUsernameUnique($_POST['elm_AddUser_Username']) === true) {
        ...
        if (isset($_POST['elm_EditUser_Username']) && isset($_POST['elm_EditUser_Email']) && isset($_POST['elm_EditUser_Password']) && isset($_POST['elm_EditUser_Id'])) {
            header("Location: index.php?isUnique".(elm_UserMgmt_isUsernameUnique($_POST['elm_AddUser_Username'], $_POST['elm_EditUser_Id']) === true ? "true" : "false"));
            if (elm_UserMgmt_isUsernameUnique($_POST['elm_AddUser_Username'], $_POST['elm_EditUser_Id']) === true) {
